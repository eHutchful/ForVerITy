<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="DivineApp.Default" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>VerITy Solutions|Home</title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="intro-text">
                        <h1 class="name">VerITy Solutions</h1>
                        <hr class="star-light">
                        <span class="skills">Web Development - Mobile App Development - Desktop Applications</span>
                    </div>
                </div>
            </div>
        </div>
